...
// Internal NEON RIPEMD-160 implementation.
...
#define LOADW(i) vld1q_u32((uint32_t *)blk[0]+i)
  ...
  // Perform 4 RIPE in parallel using NEON
...
void ripemd160neon_test() {
  ...
  ripemd160neon_32(m0, m1, m2, m3, h0, h1, h2, h3);
